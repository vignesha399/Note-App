  ...
  return (<>
    <body style={{
      ...
      <div className="container" style={{padding: '50px'}}>
        ...
        <p style={{fontSize: '20px'}}>Oops! It seems you're not logged in.</p>
        <p style={{fontSize: '20px'}}>Please login to continue.</p>
        <Link to={'login'}><a className="hover:bg-[#2980b9] hover:underline underline-offset-2" style={{
          display: 'inline-block',
          padding: '10px 20px',
          backgroundColor: '#3498db',
          color: 'white',
